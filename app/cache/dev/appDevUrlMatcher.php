...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/pagina')) {
            // pagina_ayuda
            if ($pathinfo === '/pagina/ayuda') {
                return array (  'template' => 'OfertaBundle:Sitio:ayuda.html.twig',  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController::templateAction',  '_route' => 'pagina_ayuda',);
            }

            // pagina_privacidad
            if ($pathinfo === '/pagina/privacidad') {
                return array (  'template' => 'OfertaBundle:Sitio:privacidad.html.twig',  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController::templateAction',  '_route' => 'pagina_privacidad',);
            }

            // pagina_condiciones
            if ($pathinfo === '/pagina/terminos-y-condiciones') {
                return array (  'template' => 'OfertaBundle:Default:condiciones.html.twig',  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController::templateAction',  '_route' => 'pagina_condiciones',);
            }
        ...
        if (0 === strpos($pathinfo, '/sitio') && preg_match('#^/sitio/(?P<pagina>[^/]++)/?$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => '_pagina_estatica')), array (  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction',  'route' => 'pagina_estatica',));
        }
